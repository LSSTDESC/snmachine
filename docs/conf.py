...
latex_documents = [
  ('index', 'snmachine.tex', u'snmachine Documentation',
   u'Michelle Lochner', 'manual'),
]
...
man_pages = [
    ('index', 'snmachine', u'snmachine Documentation',
     [u'Michelle Lochner'], 1)
]
...
texinfo_documents = [
  ('index', 'snmachine', u'snmachine Documentation',
   u'Michelle Lochner', 'snmachine', 'One line description of project.',
   'Miscellaneous'),
]
